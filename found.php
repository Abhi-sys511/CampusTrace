<h1 class="pageTitle text-center">Post Lost or Found Item</h1>
        ...
        <div class="card">
            <div class="card-body py-4">
                ...
                <form action="" id="item-form">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="title" class="control-label">Title for your post</label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="number" name="contact" id="contact" class="form-control form-control-sm rounded-0" value="<?php echo isset($contact) ? $contact : ''; ?>"  required/>
                        </div>
                    </div>
                    </div>
                    <div class="row">
